...
class s4GAN_discriminator(nn.Module):
    ...
    def __init__(self, num_classes, n_input_channels=2, ndf=64):
        super(s4GAN_discriminator, self).__init__()

        self.conv1 = nn.Conv2d(num_classes + n_input_channels, ndf, kernel_size=4, stride=2, padding=1)  # 160 x 160
        ...
        #     self.avgpool = nn.AvgPool2d((45, 60))

        # Note(nik): global spatial average pooling, i think thats what he is trying to do there
